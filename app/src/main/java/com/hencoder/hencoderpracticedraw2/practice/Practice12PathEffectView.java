...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        PathEffect discretePathEffect = new DiscretePathEffect(10,4);
        ...
        // 第三处：DashPathEffect
        PathEffect dashPathEffect = new DashPathEffect(new float[]{10,10,20,12},0);
        ...
        dashPath.moveTo(40,10);
        dashPath.rLineTo(20,20);
        dashPath.rLineTo(-20,0);
        dashPath.close();

        PathEffect pathDashEffect = new PathDashPathEffect(dashPath,40,0, PathDashPathEffect.Style.TRANSLATE);
